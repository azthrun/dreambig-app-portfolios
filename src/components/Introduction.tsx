  ...
  return (
    <section id="introduction" className="relative isolate overflow-hidden py-28">
      ...
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <p className="animate-slide-up mt-6 text-lg leading-8 text-slate-600 dark:text-slate-400">
          {portfolioData.introduction[0]}
        </p>
        <p className="animate-slide-up mt-3 text-lg leading-8 text-slate-600 dark:text-slate-400">
