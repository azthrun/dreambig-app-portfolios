...
export const portfolioData: PortfolioData = {
  ...
  projects: [
    {
      title: "Project Alpha",
      description: "A real-time chat application built with SignalR and React, allowing users to communicate seamlessly.",
      technologies: ["SignalR", "React", "TypeScript", ".NET Core"],
      link: "#"
    },
    {
      title: "Project Beta",
      description: "A task management tool designed to help teams organize and track their work effectively.",
      technologies: ["ASP.NET Core", "Angular", "SQL Server"],
      link: "#"
    },
    {
      title: "Project Gamma",
      description: "An e-learning platform offering interactive courses and quizzes on various subjects.",
